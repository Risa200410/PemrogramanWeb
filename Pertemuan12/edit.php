<?php
require_once 'crud.php'; //mengimpor file crud.php

$crud = new Crud(); // membuat instance dr kelas crud

// ketika metode adalah POST, akan ditambahkan data ke dalam database
...
// untuk mengambil semua jabatan yang ada dan disimpan pada variable $tampil
$tampil = $crud->read();
?>
...
<body>
    <div class="container mt-5">
        ...
        <table class="table">
            ...
            <tbody>
                <?php
                // menampilkan data jabatan dalam bentuk tabel
    ...
    <!-- bootstrap untuk form input baru -->
